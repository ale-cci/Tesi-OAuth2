...
keys\footnote{If you are interested in api keys:
...
\subsection{An use case with some terminology}
...
Let's assume that you have uploaded some photos or videos on google drive of a
vacation you recently did, and now you want to use
