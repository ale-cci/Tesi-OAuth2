...
This protocol is a bit "quicker" than the other one (if you want to define it
...
extension could perform oauth requests with your account, without you having to
give it the permissions!

A solution to this problem is discussed later in this dissertion in the PKCE
