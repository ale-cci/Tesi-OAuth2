...
keys\footnote{If you are interested in api keys: https://en.wikipedia.org/wiki/Application\_programming\_interface\_key} for it's similar use, this protocol grant
