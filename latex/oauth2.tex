...
OpenID works.
\subsection{Examples}
Some code examples will be included alongside the explanation, written in python.
...
%==============================================================================
\subsection{Different types of grant}
% OAuth2 is an authorization framework, that enables application to obtain limited
% access to user accounts on an HTTP service.
% It works by delegating the user authentication to the service that hosts the
% user account, and authorizing third-party application to access the user accout.
%
